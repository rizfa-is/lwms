---
name: mcp-fastmcp
description: FastMCP server patterns. Use when registering MCP tools, choosing transports, setting hints, or editing src/lwms/server.py and cli.py.
---
