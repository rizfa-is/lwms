---
name: code-reviewer
description: Reviews code for safety, correctness, and style after Python changes. Use after writing or modifying code, or when invoked via /pr-review. Heavy on trading-safety checks.
model: opus
---
...
- Adding pending orders / history / ticks — explicitly out of scope.
