...
- Treat any password the user pasted in chat as compromised; for any
...
- Use the prefix conventions: `feat/`, `fix/`, `chore/`, `docs/`, `test/`.
...
It does **not** mean cutting corners on safety. The scaffold intentionally
