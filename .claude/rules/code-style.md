---
name: code-style
description: Code style rules for lwms. Type hints, logging, error handling, no print() in stdio mode.
---
...
Retries on broker errors belong in a single, well-tested place. Handlers
return one attempt's result. Do not silently re-send orders.
